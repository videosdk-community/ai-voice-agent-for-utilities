...
This repository contains ai voice agent for utilities, built using the VideoSDK Agents architecture with a [Pipeline (Cascade Mode)](https://docs.videosdk.live/ai_agents/core-components/pipeline).
